...
enum class EMovementDataType : uint8
{
	...
	ExtraJumpHeight UMETA(DisplayName = "ExtraJumpHeight"),
	DoubleJumpHeight UMETA(DisplayName = "DoubleJumpHeight"),
	WallJumpHeight UMETA(DisplayName = "WallJumpHeight"),
	JumpHorizontalBoost UMETA(DisplayName = "JumpHorizontalBoost"),
	MaxJumpHoldTime UMETA(DisplayName = "MaxJumpHoldTime"),
